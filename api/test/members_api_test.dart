...
void main() {
  // final instance = MembersApi();

  group('tests for MembersApi', () {
    // leave group or delete group when the user is the last group member
    //
    //Future deleteMemberFromGroup(String groupId, String userId) async
    test('test deleteMemberFromGroup', () async {
      // TODO
    });
    ...
    test('test getGroupRanking', () async {
      // TODO
    });
