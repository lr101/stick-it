...
class LastSeenFamily extends Family<DateTime?> {
  ...
  LastSeenProvider call(String key) {
    return LastSeenProvider(key);
  }

  @override
  LastSeenProvider getProviderOverride(covariant LastSeenProvider provider) {
...
class LastSeenProvider extends NotifierProviderImpl<LastSeen, DateTime?> {
  ...
  @override
  DateTime? runNotifierBuild(covariant LastSeen notifier) {
...
class _LastSeenProviderElement
    extends NotifierProviderElement<LastSeen, DateTime?>
    with LastSeenRef {
