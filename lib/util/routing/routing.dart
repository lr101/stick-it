  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return ImageUpload(
          image: image, 
          position: LatLng(double.parse(state.uri.queryParameters['lat']!), double.parse(state.uri.queryParameters['long']!)),
        );
      },
    ),
    ...
    GoRoute(
      ...
      name: 'groupEdit',
      builder: (context, state) => GroupEdit(groupid: state.pathParameters['id']!,),
    ),
    ...
    GoRoute(
      path: '/users/:id',
      name: 'userProfile',
      builder: (context, state) => OtherUserProfile(userId: state.pathParameters['id']!),
    ),
    ...
    GoRoute(
      path: '/pins/:id',
      name: 'viewImage',
      builder: (context, state) => ViewImage(pinId: state.pathParameters['id']!),
    ),
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(path: 'profile', name: "profileSettings", builder: (context, state) => const ChangeProfile()),
        GoRoute(path: 'password', name: "pswSettings", builder: (context, state) => const ChangePassword()),
        GoRoute(path: 'email', name: "emailSettings", builder: (context, state) => const ChangeEmailPage()),
        GoRoute(path: 'hidden-posts', name: "hiddenPostSettings", builder: (context, state) => const EditHiddenPosts()),
        GoRoute(path: 'hidden-users', name: "hiddenUserSettings", builder: (context, state) => const EditHiddenUsers()),
        GoRoute(path: 'delete-account', name: "deleteSettings", builder: (context, state) => const DeleteAccount()),
      ]
    ),
