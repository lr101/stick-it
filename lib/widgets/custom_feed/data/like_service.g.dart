...
String _$likeServiceHash() => r'f67b3cfae766e26979bd2510d6062428dac4d570';
...
class LikeServiceFamily extends Family<AsyncValue<PinLikeDto>> {
  ...
  LikeServiceProvider call(String pinId) {
    return LikeServiceProvider(pinId);
  }
...
class LikeServiceProvider
  ...
  /// See also [LikeService].
  LikeServiceProvider(String pinId)
    : this._internal(
        ...
        allTransitiveDependencies: LikeServiceFamily._allTransitiveDependencies,
        pinId: pinId,
      );
  ...
  @override
  FutureOr<PinLikeDto> runNotifierBuild(covariant LikeService notifier) {
