    ...
    return Row(
          children: [
            LikeButtonAnimated(
              ...
              isLiked: pinLike.valueOrNull?.likedByUser,
              likeBuilder: (isLiked) {
                return Icon(
                  Icons.favorite,
            ...
            LikeButtonAnimated(
              ...
              isLiked: pinLike.valueOrNull?.likedLocationByUser,
              likeBuilder: (isLiked) {
                return Icon(
            ...
            LikeButtonAnimated(
              ...
              isLiked: pinLike.valueOrNull?.likedPhotographyByUser,
              likeBuilder: (isLiked) {
                return Icon(
                  Icons.photo_camera,
                  color: isLiked ? Colors.red : Colors.grey,
            ...
            LikeButtonAnimated(
              ...
              isLiked: pinLike.valueOrNull?.likedArtByUser,
              likeBuilder: (isLiked) {
                return Icon(
                  Icons.brush,
                  color: isLiked ? Colors.red : Colors.grey,
