        ...
        child: Row(
          ...
          children: [
            ...
            if (orderedIds.isEmpty)
              Icon(Icons.visibility_off, size: 20, color: theme.colorScheme.onSurfaceVariant)
            else
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    for (int i = 0; i < orderedIds.length && (i < 3 || orderedIds.length == 4); i++)
                      Positioned(
                        left: i * 12.0,
                        child: Container(
                          ...
                          child: RoundImage(
                            size: 14,
                            imageCallback: ref.watch(groupProfilePictureSmallByIdProvider(orderedIds[i])),
                            child: Container(),
                          ),
                        ),
                      ),
              ...
              TextButton(
                onPressed: () {
                   for(final groupId in orderedIds) {
                      ref.read(groupActiveServiceProvider.notifier).toggle(groupId, true);
                   }
                },
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: GestureDetector(
                      ...
                      child: Stack(
                        ...
                        children: [
                          RoundImage(
                            size: 20,
                            imageCallback: ref.watch(groupProfilePictureSmallByIdProvider(groupId)),
                            child: Container(),
                          ),
                          if (isActive)
                            Container(
                    ...
                    trailing: ReorderableDragStartListener(
                      index: index,
                      child: Icon(Icons.drag_handle, color: theme.colorScheme.outlineVariant),
                    ),
                  ),
                );
              },
